...
public class VehiclesCollection<Vehicles> {
    ...
    public ArrayList<Vehicle> getWholeCollection(){ return collectionOfVehicles;}

    public void override(ArrayList<Vehicle> newdata){
        this.collectionOfVehicles = newdata;
